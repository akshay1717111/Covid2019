    ...
    new Vue({
        ...
        methods: {
            ...
            bass: function (a, b, c, d) {
                var tltp = "<strong>" + "TX_date:" + a + "</strong>" + "<br>" + "<strong>" + "Total_Revenue:" + b + "</strong>" + "<br>" + "<strong>" + "Total_Payment:" + c + "</strong>" + "<br>" + "<strong>" + "Withdrawal:" + d + "</strong>" + "<br>";
                return tltp;
            },
            trend: function (r_data) {
                date = [], count = [], pay = [],withdraw=[];
                for (var i = 0; i < r_data.length; i++) {
                    date.push(r_data[i].TX_date)
                    count.push(r_data[i].Total_Revenue)
                    pay.push(r_data[i].Total_Payment)
                    withdraw.push(r_data[i].Withdrawal)
                }
                date.reverse();
                count.reverse();
                pay.reverse();
                ...
                dataTable.addColumn('number', 'Total_Revenue');
                dataTable.addColumn({
                    type: 'string',
                    role: 'tooltip',
                    p: {
